...
public class Aula implements Serializable {
		...
		try {
			...
			while ((linea = br.readLine()) != null) {
				...
				switch (linea) {
					...
					case "--CONTACTO--":
						//Antes de analizar linea añadimos lenguaje
						al.setEstudiaLenguaje(lenguaje);
				...
				if (isAlumno) {
					...
					switch (lineaLenguaje) {
						...
						case 1:
							...
							break;
						case 2:
							lenguaje.add(Lenguaje.valueOf(linea));
							lineaLenguaje = 1;
							cantLenguajes++;
					}
					lineaLenguaje++;
					...
					switch (lineaContactos) {
						case 0:
							break;
						case 1:
							contactos = new Contacto[Integer.parseInt(linea)];
							break;
						case 2:
							tipoContacto = TipoContacto.valueOf(linea);
							break;
						case 3:
							contactos[cantContactos] = new Contacto(tipoContacto, linea);
							lineaContactos = 1;
							cantContactos++;
							break;
					}
					...
					switch (lineaDirecciones) {
						case 0:
							break;
						case 1:
							direcciones = new Direccion[Integer.parseInt(linea)];
							break;
						case 2:
						...
						case 7:
							codigoPostal = linea;
							direcciones[cantDirecciones] = new Direccion(tipoCalle, nombreCalle, numEdif, piso, puerta, codigoPostal);
							lineaDirecciones = 1;
							cantDirecciones++;
							break;
					}
	...
	public static void main(String[] args) {
		...
		Alumno al1 = new Alumno(1, new GregorianCalendar(2011, 0, 01), TipoEstudio.FP, new Lenguaje[]{Lenguaje.JAVA}, "11.111.111-a", "Alumno1", "Alumno1 Alumno1", Sexo.HOMBRE, new GregorianCalendar(2000, 0, 01), EstadoCivil.SOLTERO);
		...
		Alumno al2 = new Alumno(2, new GregorianCalendar(2022, 1, 11), TipoEstudio.PRIMARIA, new Lenguaje[]{Lenguaje.JAVA, Lenguaje.JAVASCRIPT}, "22.222.222-b", "Alumno2", "Alumno2 Alumno2", Sexo.MUJER, new GregorianCalendar(2000, 1, 11), EstadoCivil.SOLTERO);
		...
		Alumno al3 = new Alumno(3, new GregorianCalendar(2023, 2, 22), TipoEstudio.SECUNDARIA, new Lenguaje[]{Lenguaje.JAVA, Lenguaje.JAVASCRIPT, Lenguaje.C}, "33.333.333-c", "Alumno3", "Alumno3 Alumno3", Sexo.MUJER, new GregorianCalendar(2000, 2, 21), EstadoCivil.SOLTERO);
		...
		Alumno rafa = new Alumno(100, new GregorianCalendar(2018, 5, 10), TipoEstudio.UNIVERSIDAD, new Lenguaje[]{Lenguaje.JAVA, Lenguaje.JAVASCRIPT, Lenguaje.C, Lenguaje.CSHARP}, "36.143.961-j", "Rafael", "Martínez Costas", Sexo.HOMBRE, new GregorianCalendar(1974, 9, 6), EstadoCivil.SOLTERO);
